...
object MockTimerTemplateDataProvider {
    internal fun getMockedMapWithTimerData(isUsingDuration: Boolean, duration: String): MutableMap<String, String> {
        ...
        if (isUsingDuration) {
            ...
            map[PushTemplateConstants.PushPayloadKeys.TimerKeys.TIMER_END_TIME] = MOCKED_TIMER_EXPIRY_TIME
        }
        return map
    }
